"""Frozen 83-dim SE2 (spider_envelop_2) config, vendored for cascade_83.
...
Deviation from the verbatim source (reviewed): ``symmetry_cfg
...
class El4090Se2_83Cfg(El4090EnvelopCfg):
...
class El4090Se2_83CfgPPO(El4090EnvelopCfgPPO):
    seed = 1
