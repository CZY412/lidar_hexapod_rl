"""Frozen 83-dim SE2 (spider_envelop_2) envelope condition, vendored for cascade_83.

Source: ``legged_gym/legged_gym/envs/el_4090/spider_envelop_2/envelope_condition.py``
at commit ``fd527a8`` (merge base with ``feat/el_4090_2``).  Verbatim copy;
only this provenance header was added.  Do not modify except by an explicit,
reviewed re-vendor.
"""
