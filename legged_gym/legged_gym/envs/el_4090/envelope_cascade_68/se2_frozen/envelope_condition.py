"""Frozen 68-dim SE2 (spider_envelop_2) envelope condition, vendored for cascade_68.
...
Verbatim copy; only this provenance header was added.  Do not modify except
by an explicit, reviewed re-vendor.
"""
